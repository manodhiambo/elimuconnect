            ...
            <div className="text-center space-y-4">
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1 text-left">
                  ...
                  <li>• Look in your spam folder if needed</li>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-red-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        {/* Header */}
        <div>
          <div className="mx-auto h-16 w-16 bg-gradient-to-r from-orange-600 to-red-600 rounded-xl flex items-center justify-center">
            <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                  <p>
                    ...
                    <a href="mailto:support@elimuconnect.ke" className="underline">
                      contact support
                    </a>
                    .
                  </p>
