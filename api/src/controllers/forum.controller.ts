...
export class ForumController {
  ...
  createSchoolDiscussion = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
   ...
   id: Date.now().toString(),
      ...
      throw new ApiError('Failed to create school discussion', StatusCdes.INTERNAL_SERVER_ERROR);
    }
  });
  ...
  unpinDiscussion = asyncHandler(async (req: AicatedRequest, res: Response) => {
    const { discussionId } = req.params;
  ...
  featureDiscussion = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    try {
      ...
      throw new ApiError('ed to feature discussion', StatusCodes.INTERNAL_SERVER_ERROR);
    }
  });
  ...
  getTrendingTopics = asyncHandler(async (req: Request, res: Response) => {
    ...
    } catch (error)   throw new ApiError('Failed to retrieve trending topics', StatusCodes.INTERNAL_SERVER_ERROR);
    }
  });
  ...
  markNotificationAsRead = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    try {
      ...
      throw new ApiError('Failed to mark notification as read', StatusCodes.INTERNAL_VER_ERROR);
    }
  });
